...
const PortfolioNew = () => {
    const projects = [
        ...
        },
        {
            ...
            description: "A responsive music streaming application with modern UI",
            ...
            <div className="container-max">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                        Showcasing my latest projects and creative solutions that demonstrate my skills and passion for development
                    </p>
                </div>
                        ...
                        >
                            ...
                            <div className="relative overflow-hidden">
                                ...
                                <div className="absolute inset-0 flex items-center justify-center space-x-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    <a 
                                        href={project.link}
                                        className="w-12 h-12 bg-white rounded-full flex items-center justify-center hover:bg-primary-500 hover:text-white transition-colors duration-300"
                                        target="_blank"
                            ...
                            {/* Project Content */}
                            <div className="p-6">
                                <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-primary-500 transition-colors duration-300">
                                    {project.title}
                                </h3>
